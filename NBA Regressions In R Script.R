...
NBA = read.csv("/Users/shaunstewart/Desktop/GW Boot Camp/Final Project - GW Bootcamp/R_Analysis/NBA_Data_R.csv")
...
Games = read.csv("/Users/shaunstewart/Desktop/GW Boot Camp/Final Project - GW Bootcamp/R_Analysis/games_clean.csv")
